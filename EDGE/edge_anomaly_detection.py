...
for n in range(5):
    ...
    edge_cls_GATOR = alliGATOR(f"./wandb/Synthetic_K7_edge/multinomial_diffusion/multistep/DS5A331", 212, MC = 100, name = "edge_cls-sense-analysis", lambda_guidance=4.5, 
                               sample_numbers=1894, tuning=False, anomaly_type="edge_anomaly", seed=n)
...
plt.legend()
plt.savefig("2edge-prob-adj-EAD-Gator-AUPRC")
...
plt.yscale('log')
plt.legend()
plt.savefig("2edge-prob-adj-EAD-GATOR-score-dist")
plt.show()
