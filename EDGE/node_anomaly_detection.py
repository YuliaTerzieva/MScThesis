...
for n in range(10):
    ...
    node_anomaly_gator = alliGATOR(f"./wandb/Id_theft_K{15}/multinomial_diffusion/multistep/K{15}DS{8}A{21}", 799, MC = 100, name = f"K{15}DS{8}A{21}", lambda_guidance=4.5, 
