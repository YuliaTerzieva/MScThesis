...
plt.yscale('log')
plt.legend()
plt.savefig(f"Plots_Isolation_Forest_EAD/{reduction_function}-EAD-ISOFOREST_score-dist")
plt.show()
...
plt.legend()
plt.ylim([0, 1.05])
plt.savefig(f"Plots_Isolation_Forest_EAD/{reduction_function}-EAD-ISOFOREST_AUPRC")
plt.show()
